...
class UserLoginServiceImpl implements UserLoginService {
  ...
  @override
  Future<User?> login(String email, String password) => _userLoginRepository.login(email, password);

  @override
  Future<void> forgotPassword(String email) => _userLoginRepository.forgotPassword(email);
  ...
  @override
  Future<void> updateDisplayName(String name) => _userLoginRepository.updateDisplayName(name);
}
